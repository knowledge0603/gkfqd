...
{
    public partial class gk01b : WinFormsUI.Docking.DockContent
    {
        #region  变量定义区域
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            gk019 frmgk019 = new gk019(importDatasource, dgvr, strProjectName, "已录入", dataSet8.Tables[0], dataSetTownName1.Tables[0].Rows[0]["项目所在县"].ToString());
            frmgk019.Owner = this;
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            sqlQuery.Append("  AND  FKXMMC= '" + strProjectName + "'");
